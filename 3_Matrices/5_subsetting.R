...
Games[1:3, 8:10]
is.matrix(Games[1:3, 8:10])
# First and last rows, all columns
Games[c(1,10), ]

# All rows and two columns
Games[ , c("2009", "2010")]
...
# In the lat cases above the use of the squared brakets produced a vector
# If we want to get back a matrix we have to specify another parameter
Games[1, , drop=F]
