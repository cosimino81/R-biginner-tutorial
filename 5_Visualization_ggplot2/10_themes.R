...
h <- o + geom_histogram(binwidth = 10, color= "Black", aes(fill = Genre))
...
h + xlab("Money Axis") + ylab("Number of Movies") +
    ...
    theme(# axis tittle
          ...
          axis.text.y = element_text(colour = "Orange", size = 10),
          # plot title
          plot.title = element_text(colour = "DarkGreen", size = 20, family = "Courier"),
          # plot legend text
